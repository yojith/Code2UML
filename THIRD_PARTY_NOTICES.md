...
The VSIX contains the exact vcpkg source downloads, port material, applied patches, build metadata, installed-file inventory, and upstream license/provenance material described above under `licenses/graphviz/`.

...
try {
    ...
    $required = 'extension/out/src/extension.js', 'extension/package.json', 'extension/media/python2uml.svg', 'extension/media/codicons/codicon.css', 'extension/media/codicons/codicon.ttf', 'extension/media/codicons/LICENSE', 'extension/media/codicons/LICENSE-CODE', 'extension/python-runtime/python.exe', 'extension/python-runtime/Lib/site-packages/python2uml/__init__.py', 'extension/python-runtime/Lib/site-packages/graphviz/__init__.py', 'extension/python-runtime/Lib/site-packages/tree_sitter_c/_binding.pyd', 'extension/python-runtime/Lib/site-packages/tree_sitter_cpp/_binding.pyd', 'extension/python-runtime/Lib/site-packages/tree_sitter_java/_binding.pyd', 'extension/graphviz/bin/dot.exe', 'extension/licenses/python/LICENSE.txt', 'extension/licenses/graphviz/LICENSE', 'extension/licenses/graphviz/vcpkg/commit.txt', 'extension/licenses/graphviz/vcpkg/provenance.json', 'extension/licenses/graphviz/vcpkg/downloads/graphviz-graphviz-15.0.0.tar.gz', 'extension/licenses/graphviz/vcpkg/ports/graphviz/msvc-stdalign.diff', 'extension/licenses/graphviz/vcpkg/installed/vcpkg/status', 'extension/licenses/graphviz/vcpkg/installed/vcpkg/info/graphviz_15.0.0_x64-windows.list', 'extension/licenses/graphviz/vcpkg/buildtrees/graphviz/x64-windows.vcpkg_abi_info.txt', 'extension/THIRD_PARTY_NOTICES.md'
    $required | ForEach-Object { if ($entries -cnotcontains $_) { throw "Missing required VSIX entry: $_" } }
    foreach ($prefix in 'extension/graphviz/lib/', 'extension/graphviz/share/', 'extension/licenses/graphviz/share/', 'extension/licenses/graphviz/vcpkg/ports/', 'extension/licenses/graphviz/vcpkg/downloads/', 'extension/licenses/graphviz/vcpkg/installed/vcpkg/info/', 'extension/licenses/graphviz/vcpkg/buildtrees/') {
